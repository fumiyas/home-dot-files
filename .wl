...
;	)
	    ...
	    ("^\\[sugj-doc:" . "+ml/samba/sugj-doc")
	    ("^\\[sugj-web:" . "+ml/samba/sugj-web")

	    ("^\\[debian-users:" . "+ml/linux/debian-users")
	    ("^\\[debian-devel:" . "+ml/linux/debian-devel")
	    ("^\\[blue:" . "+ml/linux/blue")
	    ("^\\[blue-free:" . "+ml/linux/blue-free")

	    ;("^\\[PHP-users " . "+ml/web/php-users")
	    ;("^\\[PHP-dev " . "+ml/web/php-dev")
...
;	    ("ezmlm@list.cr.yp.to" . "+ml/net/djb-ezmlm")
;	    ("password@list.cr.yp.to" . "+ml/net/djb-password")
;	    ("q-beginners@kita-q.com" . "+ml/net/qmail-beginners")

	    ("-admin-@samba.gr.jp" . "+ml/samba/sugj-bounce")
	    ("-admin-.+=[a-z0-9.-]+@samba.gr.jp" . "+ml/samba/sugj-bounce")
	    ("perl-oo@freeml.com" . "+ml/develop/perl-oo")
	)
        ("Return-Path"
	    ("samba-technical-bounces" . "+ml/samba/samba-technical")

;	    ("suspend2-devel-bounces@" . "+ml/linux/swsusp")
;	    ("suspend2-help-bounces@" . "+ml/linux/swsusp")
;	    ("suspend2-users-bounces@" . "+ml/linux/swsusp")
...
;	    ("xfs-bounce@" . "+ml/linux/xfs")
	    ...
	    ("memo-admin\\+.*@memo.st.ryukoku.ac.jp" . "+ml/misc/security-memo")
	    ("ml-admin@mysql.gr.jp" . "+ml/db/mysql-jp")
;	    ("classdbi-bounces@lists.digitalcraftsmen.ne" . "+ml/db/cdbi-talk")
;	    ("dbix-class-bounces@lists.rawmode.org" . "+ml/db/dbix-class")
...
;	    ("bgware-return-" . "+ml/net/bgware")
;	    ("qmail-return-" . "+ml/net/djb-qmail")
;	    ("qmaildist-return-" . "+ml/net/djb-qmaildist")
;	    ("djbdns-return-.*@qmail.jp" . "+ml/net/djbdns")
;	    ("djbtools-return-.*@qmail.jp" . "+ml/net/djbtools")
;	    ("sentto-3122687-.*@returns.yahoogroups.jp" . "+ml/net/djb-jp")

	    ("discuss-return-.*@ja.openoffice.org" . "+ml/misc/ooo-discuss")
	    ("dev-return-.*@ja.openoffice.org" . "+ml/misc/ooo-dev")

	    ("ruby-list-admin@" . "+ml/develop/ruby-list")
	    ("ruby-dev-admin@" . "+ml/develop/ruby-dev")
	    ("rails=return=" . "+ml/develop/rails")
;	    ("sledge-users-bounces@" . "+ml/develop/sledge-users")
;	    ("jcode5-return-" . "+ml/develop/jcode-perl")
	    ("subversion-jp-bounces@" . "+ml/develop/subversion-jp")
	    ("skk-return-" . "+ml/misc/skk")
	    ("nakajima.yasushi-pdfj-return-" . "+ml/misc/pdfj")
;	    ("sentto-2296978-" . "+ml/misc/docbook")
	    ("edict-return-" . "+ml/misc/edict")
	    ("jabber-return-" . "+ml/net/jabber")
	    ("iohack-users-bounces@" . "+ml/misc/iohack")
